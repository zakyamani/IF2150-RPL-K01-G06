...
| A04 | *Menelusuri Penawaran Anonim* | *Pembeli mengatur filter pengecualian alergen dan melihat daftar penawaran berdasarkan kategori, kuota tersisa, harga, jarak perkiraan, dan jendela pickup tanpa identitas merchant.* | *US-05*|
| A05 | *Melakukan Pembayaran* | *Pembeli membayar paket yang dipilih melalui QRIS atau metode pembayaran digital yang didukung.* | *US-06*|
| A06 | *Membuka Detail Merchant dan QR Pickup* | *Sistem membuka nama merchant, alamat pickup, dan menghasilkan QR pickup sekali pakai setelah pembayaran berhasil dikonfirmasi.* | *US-07*|
| A07 | *Mengambil Paket di Lokasi* | *Pembeli datang pada perkiraan waktu yang ditentukan dan menunjukkan QR pickup kepada penjual.* | *US-08*|
| A08 | *Memindai QR Pickup* | *Penjual memindai QR pickup pembeli sebagai bukti serah-terima, memicu status transaksi berubah dan payout dijadwalkan.* | *US-04*|
