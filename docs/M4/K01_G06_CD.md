...
<p align="center">
<img alt="Class Diagram UC05" src="./assets/diagram/class-diagram-UC05.webp" width="70%">
</p>
<p align="center">
...
<p align="center">
<img alt="Class Diagram UC06" src="./assets/diagram/class-diagram-UC06.webp" width="70%">
</p>
<p align="center">
...
<p align="center">
<img alt="Class Diagram UC07" src="./assets/diagram/class-diagram-UC07.webp" width="70%">
</p>
<p align="center">
...
<p align="center">
<img alt="Class Diagram Keseluruhan" src="./assets/diagram/class-diagram-overall.webp" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Penjual* | *idPenjual, namaToko, alamat, koordinatGPS, saldoRekening* | *buatPenawaran(), batalkanPesanan(), tarikDana()* |
| *C02* | *Pembeli* | *idPembeli, nama, email, filterAlergenAktif* | *checkoutPesanan(), ajukanRefund(), beriUlasan()* |
| *C03* | *Penawaran* | *idPenawaran, kategori, alergen, kuota, hargaNormal, hargaDiskon, jendelaPickup* | *simpanPenawaran(), kurangiKuota(), tutupPenawaran()* |
| *C04* | *Pesanan* | *idPesanan, totalHarga, statusPesanan, waktuDibuat* | *buatPesanan(), perbaruiStatus(), tandaiSelesai()* |
...
| *C08* | *QRPickup* | *idToken, kodeHash, statusValid* | *generateQR(), validasiQR()* |
| *C09* | *Pengaduan* | *idPengaduan, alasan, statusPenyelesaian* | *prosesRefund(), tanganiNoShow()* |
| *C10* | *Ulasan* | *idUlasan, rating, komentar, waktuUlasan* | *simpanUlasan(), tampilkanUlasan()* |
| *C11* | *RiwayatTransaksi* | *idRiwayat, logData, metrikDampak* | *catatLog(), tampilkanRiwayat()* |
...
| :--- | :--- | :--- |
| *C01* | *UC02, UC03, UC06, UC07* | *KF01, KF02, KF06, KF07, KF08, KF09, KF10, KF13, KF14* |
| *C02* | *UC01, UC04, UC05, UC06, UC07* | *KF03, KF04, KF05, KF11, KF12, KF13, KF14* |
| *C03* | *UC01, UC02, UC03* | *KF03, KF04, KF06, KF07, KF08, KF09, KF10* |
| *C04* | *UC03, UC04, UC05, UC06, UC07* | *KF02, KF05, KF09, KF10, KF12, KF13, KF14* |
| *C05* | *UC03* | *KF01, KF02, KF09* |
| *C06* | *UC03, UC05* | *KF10, KF11, KF12* |
| *C07* | *UC06* | *KF13* |
| *C08* | *UC07* | *KF14* |
