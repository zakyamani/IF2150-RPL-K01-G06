...
| Revisi | Deskripsi |
| :--- | :--- |
| *A* | Menyusun draf Kebutuhan Fungsional (Bab 2), spesifikasi identifikasi Use Case UC01–UC07 (Bab 3.2), serta skenario use case normal dan alternatif (Bab 3.4). |
| *B* | Menyematkan Use Case Diagram monokrom UML 2.5 (Bab 3.3) beserta pemutakhiran relasi extend dan dependensi sistem. |
| *C* |  |
| ... |  |
...
<br>
<p align="center">
  <img alt="Use Case Diagram Sistem Marketplace SisaRasa" src="./assets/diagram/use-case-diagram.webp" width="95%">
</p>
<p align="center">
